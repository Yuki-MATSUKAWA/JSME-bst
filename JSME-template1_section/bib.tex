...
\label{ssec:article}
\begin{tcolorbox}[enhanced, title=\texttt{@article}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
...
\label{ssec:book}
\begin{tcolorbox}[enhanced, title=\texttt{@book}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
...
\label{ssec:booklet}
\begin{tcolorbox}[enhanced, title=\texttt{@booklet}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
        \tttitle
        \item オプション項目 \\
...
\label{ssec:comment}
\begin{tcolorbox}[enhanced, title=\texttt{@comment}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
        無し
        \item オプション項目 \\
...
\label{ssec:inbook}
\begin{tcolorbox}[enhanced, title=\texttt{@inbook}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
...
\begin{tcolorbox}[enhanced, title=\texttt{@incollection}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
...
\begin{tcolorbox}[enhanced, title=\texttt{@inproceedings}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
        \ttauthor, \tttitle, \ttbooktitle, \ttyear
        \item オプション項目 \\
...
\label{ssec:manual}
\begin{tcolorbox}[enhanced, title=\texttt{@manual}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
        \tttitle
        \item オプション項目 \\
...
\begin{tcolorbox}[enhanced, title=\texttt{@mastersthesis}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
...
\label{ssec:misc}
\begin{tcolorbox}[enhanced, title=\texttt{@misc}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
        無し
        \item オプション項目 \\
...
\label{ssec:online}
\begin{tcolorbox}[enhanced, title=\texttt{@online}, drop fuzzy shadow]
    \begin{itemize}
        \item 使用可能項目 \\
...
\begin{tcolorbox}[enhanced, title=\texttt{@phdthesis}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
        \ttauthor, \tttitle, \ttschool, \ttyear
        \item オプション項目 \\
...
\begin{tcolorbox}[enhanced, title=\texttt{@proceedings}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
        \tttitle, \ttyear
        \item オプション項目 \\
...
\begin{tcolorbox}[enhanced, title=\texttt{@techreport}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
...
\begin{tcolorbox}[enhanced, title=\texttt{@unpublished}, drop fuzzy shadow]
    \begin{itemize}
        \item 必須項目 \\
