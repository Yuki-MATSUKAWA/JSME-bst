...
\end{quote}
    ...
    また，引用する文献自体は日本語文献であっても，図表中のキャプション内など英語で引用しなければいけない場面で重宝すると思います．
...
\end{verbatim}
出力：Cited from \citetalias{松川:修論2023}.
\end{quote}
...
\end{verbatim}
出力：Cited from my master's thesis \citepalias{松川:修論2023}.
\end{quote}
\end{itemize}
...
\begin{table}[t]
    ...
    \begin{tabular}{ll}
        ...
        % \verb|\citetalias{塚原:ながれ2015}|     &\citetalias{塚原:ながれ2015} \\
        % \verb|\citepalias{塚原:ながれ2015}|     &\citepalias{塚原:ながれ2015} \\
        \multicolumn{2}{c}{------著者3名以上------} \\
