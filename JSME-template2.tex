...
Overleaf\footnote{Overleaf, \textless\verb|https://ja.overleaf.com|\textgreater}なら「リコンパイル」を押すだけなので簡単です．

\clearpage
\section*{謝辞}
\addcontentsline{toc}{section}{謝辞}
\jsmefile は武田史郎氏作の経済学用\BibTeX{}スタイルファイル\verb|jecon.bst|\footnote{\verb|jecon-bst|, \textless\verb|https://github.com/ShiroTakeda/jecon-bst|\textgreater}を改変して作成したものです．
