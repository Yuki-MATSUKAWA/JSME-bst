...
もし文書全体のフォントを{\usefont{OT1}{cmr}{m}{n} Computer Modern}に変更したいときは\verb|\usepackage{newtxtext,newtxmath}|をコメントアウトし，{\usefont{T1}{pplx}{m}{n} Palatino}に変更したいときは\verb|\usepackage{mathpazo}|のコメントアウトを外します．
