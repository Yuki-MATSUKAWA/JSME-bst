...
\begin{itembox}[l]{\textgt{\large 文献リスト作成の注意事項（全体）}}
    \begin{itemize}
        \item 並び順は原則として \\
            著者（\ttauthor）$\to$タイトル（\verb|title|）$\to$誌名（\verb|journal|）・書名（\ttbooktitle）$\to$出版社（\verb|publisher|）・大学名（\verb|school|）・機関名（\verb|institution|）$\to$巻（\verb|volume|）$\to$号（\verb|number|）$\to$発行年（\verb|year|）$\to$ページ（\verb|pages|）$\to$論文番号・講演番号（\verb|note|） \\
            とする．
...
\begin{itemize}
    ...
    \item \verb|school| \\
        ...
        学部の卒業論文の場合は\hyperref[ssec:misc]{\ttmisc}に分類し，\verb|school|フィールドの代わりに\verb|howpublished|を使用してください．
    \item \verb|series| \\
        書籍のシリーズを入力します．
...
\begin{screen}
    \begin{itemize}
        \item 必須項目 \\
        \ttauthor, \verb|title|, \verb|journal|, \verb|year|
        \item オプション項目 \\
        \verb|volume|, \verb|number|, \verb|pages|, \verb|month|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors} and \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{journal}} (\colorbox[gray]{0.8}{\texttt{year}}), Vol.~\colorbox[gray]{0.8}{\texttt{volume}}, No.~\colorbox[gray]{0.8}{\texttt{number}}, pp.~\colorbox[gray]{0.8}{\texttt{pages}}, \colorbox[gray]{0.8}{\texttt{note}}.
        \item 出力（日本語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors}, \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{journal}} (\colorbox[gray]{0.8}{\texttt{year}}), Vol.~\colorbox[gray]{0.8}{\texttt{volume}}, No.~\colorbox[gray]{0.8}{\texttt{number}}, pp.~\colorbox[gray]{0.8}{\texttt{pages}}, \colorbox[gray]{0.8}{\texttt{note}}.
...
\ttdoi と\verb|url|のフィールドは\jsmefile ではどちらも\verb|journal|にハイパーリンクを埋め込む操作を行うのでどちらを使っても同様の結果を得られます．
\ttdoi も\verb|url|も無い場合は\verb|journal|にハイパーリンクを埋め込みません．
...
\begin{screen}
    \begin{itemize}
        \item 必須項目 \\
        \ttauthor / \verb|editor|, \verb|title|, \verb|publisher|, \verb|year|
        \item オプション項目 \\
        \verb|volume|, \verb|number|, \verb|series|, \ttaddress, \ttedition, \verb|month|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
...
\begin{screen}
    \begin{itemize}
        ...
        \verb|title|
        \item オプション項目 \\
        \ttauthor, \verb|howpublished|, \ttaddress, \verb|month|, \verb|year|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors} and \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{howpublished}} (\colorbox[gray]{0.8}{\texttt{year}}), \colorbox[gray]{0.8}{\texttt{note}}.
        \item 出力（日本語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors}, \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{howpublished}} (\colorbox[gray]{0.8}{\texttt{year}}), \colorbox[gray]{0.8}{\texttt{note}}.
        \item \verb|bib|ファイル作成例 \vspace{-3mm}
\begin{verbatim}
...
\begin{screen}
    \begin{itemize}
        \item 必須項目 \\
        \ttauthor / \verb|editor|, \verb|title|, \ttchapter / \verb|pages|, \verb|publisher|, \verb|year|
        \item オプション項目 \\
        \verb|volume|, \verb|series|, \ttaddress, \ttedition, \verb|month|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
...
\begin{screen}
    \begin{itemize}
        ...
        \item オプション項目 \\
        \verb|editor|, \verb|pages|, \verb|organization|, \verb|publisher|, \ttaddress, \verb|month|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
...
\begin{screen}
    \begin{itemize}
        ...
        \verb|title|
        \item オプション項目 \\
        \ttauthor, \verb|organization|, \ttaddress, \ttedition, \verb|month|, \verb|year|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
...
\begin{screen}
    \begin{itemize}
        ...
        \item オプション項目 \\
        \ttaddress, \verb|month|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
...
\begin{screen}
    \begin{itemize}
        ...
        無し
        \item オプション項目 \\
        \ttauthor, \verb|title|, \verb|howpublished|, \ttarchivePrefix, \tteprint, \verb|month|, \verb|year|, \verb|note|, \verb|key|
        \item 出力（通常，英語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors} and \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{howpublished}} (\colorbox[gray]{0.8}{\texttt{year}}), \colorbox[gray]{0.8}{\texttt{note}}.
        \item 出力（通常，日本語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors}, \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{howpublished}} (\colorbox[gray]{0.8}{\texttt{year}}), \colorbox[gray]{0.8}{\texttt{note}}.
...
\begin{screen}
    \begin{itemize}
        \item 使用可能項目 \\
        \ttauthor, \verb|title|, \verb|howpublished|, \verb|month|, \verb|year|, \verb|url|, \ttdoi, \ttaccess, \verb|note|
        \item 出力（英語文献） \\
...
\begin{screen}
    \begin{itemize}
        ...
        \item オプション項目 \\
        \verb|editor|, \verb|organization|, \verb|publisher|, \ttaddress, \verb|month|, \verb|note|, \verb|key|
        \item 出力 \\
...
\begin{screen}
    \begin{itemize}
        \item 必須項目 \\
        \ttauthor, \verb|title|, \verb|institution|, \verb|year|
        \item オプション項目 \\
        \verb|type|, \verb|number|, \ttaddress, \verb|month|, \verb|note|, \verb|key|
        \item 出力（英語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors} and \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{institution}} (\colorbox[gray]{0.8}{\texttt{year}}), \colorbox[gray]{0.8}{\texttt{note}}.
        \item 出力（日本語文献） \\
            \colorbox[gray]{0.8}{\ttauthorf}, \colorbox[gray]{0.8}{\ttauthors}, \colorbox[gray]{0.8}{\ttauthort}, \colorbox[gray]{0.8}{\texttt{title}}, \colorbox[gray]{0.8}{\texttt{institution}} (\colorbox[gray]{0.8}{\texttt{year}}), \colorbox[gray]{0.8}{\texttt{note}}.
        \item \verb|bib|ファイル作成例 \vspace{-3mm}
\begin{verbatim}
