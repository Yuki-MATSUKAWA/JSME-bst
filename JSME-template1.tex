...
ただ，基本的に実在の文献を集めて載せているので学位論文（\verb|phdthesis|, \verb|mastersthesis|）のように原則著者が一人のものや\verb|manual|，\verb|unpublished|など一部のエントリでは全てのパターンを網羅できていない場合もあるのでご了承ください（ただ，参考にするうえで困ることのないくらいにはパターンを網羅しているつもりです）．
