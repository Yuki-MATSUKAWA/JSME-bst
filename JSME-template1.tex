...
\end{verbatim}
\end{quote}
のように\verb|bib|ファイルに書いていた場合，文中で引用した際に
\begin{table}[h]
    \centering
    \begin{tabular}{ll}
        コマンド    &出力結果 \\
...
技術報告書を発行している研究機関はさまざまありますが，例えばNASA\footnote{アメリカ航空宇宙局（NASA）, \textless\url{https://ntrs.nasa.gov/}\textgreater}やJAXA\footnote{宇宙航空研究開発機構（JAXA）, \textless\url{https://www.jaxa.jp/}\textgreater}，鉄道総研\footnote{鉄道総合技術研究所（鉄道総研）, \textless\url{https://www.rtri.or.jp/}\textgreater}などが挙げられます．
